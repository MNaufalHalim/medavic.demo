...
const Sidebar = ({ collapsed, onLogout }) => {
  ...
  return (
    <>
      ...
      <div className="fixed left-0 h-screen w-16 bg-white border-r border-gray-200 flex flex-col z-[9]">
        ...
        <div className="p-2 bg-white border-t border-gray-200">
          <button
            ...
            className="w-full flex items-center justify-center p-3 rounded-lg hover:bg-gray-50 text-gray-600"
          ...
          <button
            ...
            className="w-full flex items-center justify-center p-3 rounded-lg hover:bg-red-50 text-red-500"
            title="Logout"
          >
            <LogOut size={20} />
          </button>
      ...
      {isExpanded && (
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm z-[9999]">
          <div
            ref={sidebarRef}
            className="fixed left-0 h-screen w-64 bg-white/95 backdrop-blur-md border-r border-gray-200 flex flex-col z-[10000] animate-slideIn shadow-2xl"
          >
            {/* Header */}
