            ...
            >
              ...
              <form onSubmit={e => { e.preventDefault(); handleSave(modal.item); }}>
                <div className="space-y-5">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Nama Tindakan <span className="text-red-500">*</span></label>
                    <input
                      type="text"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        type="number"
                        className="w-full px-4 py-3 border border-gray-200 rounded-xl shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm transition-all duration-300 hover:border-blue-300 pr-12"
